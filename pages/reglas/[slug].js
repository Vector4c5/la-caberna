...
export default function ReglasDetalles() {
  ...
  return (
    <div className="w-full p-10 flex flex-col items-center bg-black bg-opacity-25">
      ...
      <div className="container flex w-10/12 h-auto gap-4 justify-center">
        <div className="container flex flex-col p-6 w-full h-auto text-justify bg-gray-800 bg-opacity-100 rounded-xl gap-2 z-20">
          <p className="text-xl">{regla.desc}</p>
        </div>
      </div>
    </div>
  );
